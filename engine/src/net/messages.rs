...
pub(crate) enum ActorMessage {
    ...
    FinalizeConnection {stream: TcpStream, connection_id: ConnectionId, }, // The host accepted your connection. Set up Tx/Rx.
...
pub(crate) struct NewConnectionMessage {
    connection: Connection,
    parent_connection_id: ConnectionId,
}

impl NewConnectionMessage {
    pub fn new(connection: Connection, parent_connection_id: ConnectionId) -> Self {
        Self {
            connection,
    ...
    pub fn unpack(self) -> (ConnectionId, Connection) {
