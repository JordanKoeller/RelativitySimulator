...
use renderer::{CubeMap, Texture, TextureBinder, TextureLike, Shader};
...
impl Uniform {
  pub unsafe fn serialize_into(&self, collector: &mut [f32], name: &str, textures: &mut TextureBinder, shader: &Shader) {
    match self {
